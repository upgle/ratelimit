...
func testNewClientImpl(t *testing.T) func(t *testing.T) {
	return func(t *testing.T) {
		redisAuth := "123"
		statsStore := stats.NewStore(stats.NewNullSink(), false)

		mkRedisClient := func(auth, addr string) redis.Client {
			return redis.NewClientImpl(statsStore, false, auth, "tcp", "single", addr, 1, nil, false, nil, 10*time.Second, "", 0, "")
		}
...
func TestDoCmd(t *testing.T) {
	...
	mkRedisClient := func(addr string) redis.Client {
		return redis.NewClientImpl(statsStore, false, "", "tcp", "single", addr, 1, nil, false, nil, 10*time.Second, "", 0, "")
	}
...
func testPipeDo(t *testing.T) func(t *testing.T) {
	return func(t *testing.T) {
		statsStore := stats.NewStore(stats.NewNullSink(), false)
...
func TestPoolOnEmptyBehavior(t *testing.T) {
	...
	mkRedisClientWithBehavior := func(addr, behavior string, waitDuration time.Duration) redis.Client {
		return redis.NewClientImpl(statsStore, false, "", "tcp", "single", addr, 1, nil, false, nil, 10*time.Second, behavior, waitDuration, "")
	}
...
func TestNewClientImplSentinel(t *testing.T) {
	...
	mkSentinelClient := func(auth, sentinelAuth, url string, useTls bool, timeout time.Duration) redis.Client {
		...
		return redis.NewClientImpl(statsStore, useTls, auth, "tcp", "sentinel", url, 1, nil, false, nil, timeout, "", 0, sentinelAuth)
	}
